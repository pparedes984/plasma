/*
 * File: app/view/wndMarcadorViewController.js
 *
...
Ext.define('plasma.view.wndMarcadorViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.wndmarcador',

    onBtnCrearMarClick: function(button, e, eOpts) {
        var me = this;
    ...
    onBtnRegresarMarClick: function(button, e, eOpts) {
        Ext.getCmp('wndMarcador').close();
    }
