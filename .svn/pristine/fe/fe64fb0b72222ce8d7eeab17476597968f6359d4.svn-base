/*
 * File: app/view/pnlMarcadorViewController.js
 *
...
Ext.define('plasma.view.pnlMarcadorViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.pnlmarcador',

    onBtnNuevoMarClick: function(button, e, eOpts) {
        var win = Ext.create('plasma.view.wndMarcador');
        win.show();
        Ext.getCmp('cbEstadoM').setValue(1);
    },

    onBtnEliminarMarClick: function(button, e, eOpts) {
        ...
        else
        {
            ...
            Ext.Ajax.request({
                url: '../servidor/plasma/marcador/verificar',
                method:"post",
                params: {
                    id: rec.data.id
                },
