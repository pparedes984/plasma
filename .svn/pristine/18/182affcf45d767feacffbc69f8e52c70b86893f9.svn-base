/*
 * File: app/view/wndInstitucionViewController.js
 *
...
Ext.define('plasma.view.wndInstitucionViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.wndinstitucion',

    onTxtCodigoIAfterRender: function(component, eOpts) {
        Ext.Ajax.request({
    ...
    onBtnCrearInsClick: function(button, e, eOpts) {
        ...
        if (forma.isValid()) {
            Ext.Ajax.request({
                url: '../servidor/plasma/institucion/verificainstitucion',
                method:"post",
                params: {
                    nombre: Ext.getCmp('txtNombreI').getValue()
                ...
                success: function( result, request ) {
                    ...
                    if(responseData.success){
                        ...
                        Ext.Msg.alert('Atención','La institución ya existe');
                    }
                },
                failure: function(response, opts) {
                    console.log('server-side failure with status code ' + response.status);
    ...
    onBtnRegresarInsClick: function(button, e, eOpts) {
        Ext.getCmp('wndInstitucion').close();
    }
